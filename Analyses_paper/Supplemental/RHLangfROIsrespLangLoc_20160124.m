...
MyOutputFolder = '/mindhive/evlab/u/mekline/Desktop/Jokes/New_Analyses/RHLangfROIsrespLangLoc_20160124_results'; %Where should the results wind up? For testing this script, this is all u need to change and it should just work! Note: usually the scripts are good about this but this one actually does break if you put a slash at the end of your dir name.

...
num_rois = 7; %18 ROIs for the MD loc! %XYZ NEEDS CHANGE!
...
%old/sphere ToM
%roi_pres_order = [1:5]';
%roi_names = {'one', 'two', 'three', 'four', 'five'};

%new ToM
roi_pres_order = [1:7]';
roi_names = {'DMPFC','LTPJ','MMPFC','PC','RTPJ','VMPFC','RSTS'};

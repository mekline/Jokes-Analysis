...
MyOutputFolder = '/mindhive/evlab/u/mekline/Desktop/Jokes/New_Analyses/TEMPLATE_results'; %Where should the results wind up? For testing this script, this is all u need to change and it should just work! Note: usually the scripts are good about this but this one actually does break if you put a slash at the end of your dir name.

firstlevel_loc = 'firstlevel_langlocSN'; % path to the first-level analysis directory for the lang localizer or whatever
firstlevel_crit = 'firstlevel_nonlit_met'; %path to 1st-level analysis directory for the critical task


loc_cons = {{'S-N'}}; %Which contrast used to localize issROIs?
crit_cons = {{'met','lit','met-lit','lit-met'}}; %Effect of interest contrasts: cons of the crit. experiment do we want to measure there? It could be the same as the loc! In that case SPM will make ur data independent for you :)

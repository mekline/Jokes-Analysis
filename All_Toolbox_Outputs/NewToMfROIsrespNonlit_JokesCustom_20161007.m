...
MyDataFolder = '/users/evelina9/more_evelina_files/MEGADATA.now.on.evlabfs'; % path to the data directory
...
crit_cons = {{'low','med','high','other','paramfun'}}; %Same as normal jokes, recoded by partic's ratings

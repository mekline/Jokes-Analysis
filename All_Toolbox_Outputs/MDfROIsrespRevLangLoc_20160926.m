...
crit_cons = {{'S','N','N-S' }}; %Effect of interest contrasts: cons of the crit. experiment do we want to measure there? It could be the same as the loc! In that case SPM will make ur data independent for you :)
...
experiments(1)=struct(...
    'name','loc',...% eg language localizer 

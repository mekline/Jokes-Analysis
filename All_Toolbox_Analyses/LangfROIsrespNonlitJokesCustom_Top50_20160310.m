...
MyDataFolder = '/users/evelina9/more_evelina_files/MEGADATA'; % path to the data directory
%MySPM = '/users/evelina9/fMRI_PROJECTS/spm_ss_vE/'; %the standard one
%MySPM = '/users/evelina9/fMRI_PROJECTS/spm_ss_Jun18-2015/'; %This one has the N-top-voxels options (?)
MySPM = '/users/evelina9/fMRI_PROJECTS/spm_ss_Feb1-2016/'; %more newer
...
MyOutputFolder = '/mindhive/evlab/u/mekline/Desktop/Jokes/New_Toolbox_Analyses/LangfROIsrespNonlitJokesCustom_Top50_20160310_results'; %Where should the results wind up? For testing this script, this is all u need to change and it should just work! Note: usually the scripts are good about this but this one actually does break if you put a slash at the end of your dir name.

firstlevel_loc = 'firstlevel_langlocSN'; % path to the first-level analysis directory for the lang localizer or whatever
firstlevel_crit = 'firstlevel_nonlit_joke_custom'; %path to 1st-level analysis directory for the critical task

loc_cons = {{'S-N'}}; %Which contrast used to localize issROIs?
crit_cons = {{'low','med','high','other'}}; %Each participant has their own assignment of trials to low, high humor as the loc! 
